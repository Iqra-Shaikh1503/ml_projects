...
model_filename = 'C:\\ml_projects\\notebook\\final_model.sav'
data_filename = 'C:\\ml_projects\\notebook\\modified_data_cluster.csv'
...
if not os.path.exists(model_filename):
    ...
    if not os.path.exists(data_filename):
        ...
        with st.form("my_form"):
            ...
            data = [[encoded_education, encoded_marital_status, income, kidhome, teenhome, recency, mntwines, mntfruits, mntmeatproducts, mntfishproducts, mntsweetproducts, mntgoldprods, numdealspurchases, numwebpurchases, numcatalogpurchases, numstorepurchases, numwebvisitsmonth, acceptedcmp3, acceptedcmp4, acceptedcmp5, acceptedcmp1, acceptedcmp2, age, ttl_yrs_in_comp, total_amount_spend]]
